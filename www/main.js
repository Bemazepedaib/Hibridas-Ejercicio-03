...
const routes = [
    ...
    {
        path: 'view-student',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_view-student_view-student_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./view-student/view-student.module */ 8072)).then(m => m.ViewStudentPageModule)
    },
    {
        path: 'new-student',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_new-student_new-student_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./new-student/new-student.module */ 1682)).then(m => m.NewStudentPageModule)
    },
    {
        path: 'login',
